...
flood_service = flood_viewer.FloodViewer('/home/gareth/Documents/dev/exeter/waterverse/waterverse-flood-simulation-component/wdme_flood_component/dump/output-64-75.json')
flood_service.init()
