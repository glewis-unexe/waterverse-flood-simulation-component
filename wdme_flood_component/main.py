...
flood_service = flood_viewer.FloodViewer('/home/gareth/Documents/dev/work/waterverse/waterverse-flood-simulation-component/wdme_flood_component/dump/output-64-25.json')
flood_service.init()
